...
export default function CheckBoxFilterAds(props: {
  filters: Filter;
  val: any;
  continue: boolean;
}) {
            ...
            <Flex width={"100%"}>
              <Select
                ...
                defaultValue={Options.find(
                  (o: { label: string; value: number }) => o.value == props.val
                )}
                onChange={(e) =>
                  selectOption(e.value, parseInt(props.filters.id))
                }
                options={Options}
...
CheckBoxFilterAds.defaultProps = {
  continue: false,
};
